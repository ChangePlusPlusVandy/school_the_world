...
const statuses = [
  { key: "not_started", color: "#D9D9D9", label: "NOT STARTED" },
  { key: "identified", color: "#4D7C0F", label: "IDENTIFIED" },
  { key: "agreement_signed", color: "#99C9FF", label: "AGREEMENT SIGNED" },
  { key: "construction", color: "#001F54", label: "CONSTRUCTION/IN PROGRESS" },
  { key: "dedicated", color: "#F18F01", label: "DEDICATED" },
];
...
export default function InfrastructureChart({ data }: Props) {
  ...
  return (
    <View style={styles.wrapper}>
      {/* Title */}
      <Text style={styles.title}>COMMUNITY SCHOOL STATUS</Text>
